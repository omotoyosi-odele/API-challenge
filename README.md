...
I plotted a graph of the maximum temperatures against the latitudes of over 600 cities. Based on the plot below, it is clear that temperature rises as we get closer to the equator
